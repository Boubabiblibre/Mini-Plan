 ...
 */
final class Version20250325111946 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE spaces ADD created_by_id UUID NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_DD2B6478B03A8386');
        $this->addSql('ALTER TABLE spaces DROP created_by_id');
        $this->addSql('ALTER TABLE spaces ALTER id TYPE UUID');
